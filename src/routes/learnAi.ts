...
router.post('/conversations/:id/messages', async (req: Request, res: Response) => {
  ...
  const result = await sendMessage(stableUid, id, body.content, body.idempotencyKey);
  // Never the message content itself — only outcome metadata, per this
  // repo's learnAudit() rule.
